...
export type Task = { id: string; title: string; status: string; priority: string; baselineStart?: string; baselineEnd?: string; currentEnd: string; note?: string; dependencyIds?: string[]; progressItems?: ProgressItem[] };
