...
export declare class AppController {
    ...
    projectGroups(auth: string, req: any): {
        groups: {
            name: string;
            count: number;
        }[];
    };
    dashboardFull(auth: string, req: any): {
        metrics: {
            activeProjects: number;
            todayActions: number;
            riskProjects: number;
    ...
    getTaskFull(auth: string, req: any, taskId: string): {
        task: {
            progressItems: {
                user: {
                    id: string;
    ...
    fileCollection(auth: string, req: any, projectId: string): {
        collection: {
            userId: string;
            userName: string;
            count: number;
