...
export class AppService {
  ...
  listProjects(user: User) { return { projects: this.visibleProjects(user) }; }
  ...
  projectDetail(user: User, id: string) { const project = this.requireProject(user, id); return { project, members: this.members.filter(m => m.projectId === id) }; }
