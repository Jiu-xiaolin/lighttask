...
const htmlPath = path.join(root, "mockups-v9", "index.html");
const outDir = path.join(root, "mockups-v9", "images");
const views = [
  ...
  ["doc", "05-online-doc-editor.png", "theme=letter&sidebar=compact"],
  ["sheet", "06-online-sheet-editor.png", "theme=windbell&sidebar=compact"],
  ["messages", "07-message-sync.png", "theme=windbell"],
  ["permissions", "08-permissions.png", "theme=letter"],
  ["support", "09-system-support.png", "theme=love"],
  ["profile", "10-user-settings.png", "theme=love&sidebar=compact"],
];
